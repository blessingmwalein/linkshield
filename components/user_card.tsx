...
const UserCard = () => {
  return (
    <div className="w-full max-w-sm bg-[#304146] rounded-2xl shadow-lg flex flex-col p-4 md:h-[420px] lg:w-[373px] lg:h-[432px]">
      <div className="flex flex-col items-center pb-4">
        ...
        <span className="text-lg text-white text-center mt-4 px-2">
