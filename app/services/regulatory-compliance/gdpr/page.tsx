...
import webdev from "../../../images/reg/img1.png"; // Corrected path for default image
  ...
  return (
    <>
      <div className="pb-6">
        <PageHeader
          title="GDPR"
          description="Ensure your business meets the rigorous requirements of General Data Protection Regulation (GDPR) with LinkShield’s comprehensive compliance services. We help you safeguard data, manage risks, and adhere to regulatory standards."
          image={webdev}
        />
      </div>
