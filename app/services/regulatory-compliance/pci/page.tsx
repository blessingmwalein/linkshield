...
import webdev from "../../../images/reg/img3.png"; // Corrected path for default image
  ...
  return (
    <>
      <div className="pb-6">
        <PageHeader
          title="PCI DSS"
          description="Ensure your business meets the Payment Card Industry Data Security Standard (PCI DSS) with LinkShield’s specialized services. We help you protect cardholder data and maintain rigorous security standards."
          image={webdev}
        />
      </div>
