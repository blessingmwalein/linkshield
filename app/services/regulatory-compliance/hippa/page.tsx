...
import webdev from "../../../images/reg/img2.png"; // Corrected path for default image
  ...
  return (
    <>
      <div className="pb-6">
        <PageHeader
          title="HIPAA"
          description="Achieve and maintain HIPAA compliance with LinkShield’s specialized services. We help healthcare organizations navigate the complexities of data protection, privacy, and security regulations."
          image={webdev}
        />
      </div>
