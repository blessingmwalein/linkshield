...
import webdev from "../../../images/security/img3.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="At LinkShield, we provide expert vulnerability assessments to uncover and address potential security flaws in your systems. Our thorough analysis helps you mitigate risks and strengthen your overall security posture."
          image={webdev}
        />
      </div>
