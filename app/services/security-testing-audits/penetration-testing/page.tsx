...
import webdev from "../../../images/security/img1.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="At LinkShield, we offer expert penetration testing services to identify and address vulnerabilities in your systems. Our thorough approach ensures your business remains protected against potential cyber threats."
          image={webdev}
        />
      </div>
