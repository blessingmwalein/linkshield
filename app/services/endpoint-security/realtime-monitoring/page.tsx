...
import webdev from "../../../images/endponit/img1.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="LinkShield’s real-time monitoring services provide continuous oversight of your network and systems, ensuring swift detection and response to potential threats. Protect your organization with our 24/7 monitoring solutions."
          image={webdev}
        />
      </div>
