      ...
      <div className="flex flex-col gap-6 grow p-4 md:w-1/2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <span className="font-normal text-[18px] text-black">
            Save time and costs with our cross-platform solutions that provide a consistent experience across iOS, Android, and other platforms, using technologies like React Native and Flutter.
          </span>
        </div>

        {/* Buttons Section */}
        <div className="flex items-center gap-6 pt-4">
          <button className="flex justify-center items-center gap-2 px-6 py-3 border border-black">
