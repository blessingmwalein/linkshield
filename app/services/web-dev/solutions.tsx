      ...
      <div className="flex flex-col md:flex-row justify-center gap-12 w-full">
        ...
        <div className="flex flex-col gap-8 flex-grow">
          ...
          <div className="flex flex-col items-center gap-6 w-full">
            ...
            <span className="font-normal text-[16px] text-center text-black">
              Build robust online stores with integrated payment gateways, inventory management, and user-friendly interfaces.
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 flex-grow">
          ...
          <div className="flex flex-col items-center gap-6 w-full">
            ...
            <span className="font-normal text-[16px] text-center text-black">
              Implement scalable CMS solutions that allow for easy content updates and management, tailored to your business operations.
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 flex-grow">
          ...
          <div className="flex flex-col items-center gap-6 w-full">
            ...
            <span className="font-normal text-[16px] text-center text-black">
              We will provide continuous support to keep your website updated, secure, and functioning at its best.
            </span>
          </div>
        </div>
      </div>
