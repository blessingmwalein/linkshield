...
import webdev from "../../../images/javascript.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="Unlock the full potential of your web and mobile applications with LinkShield’s cutting-edge JavaScript development services. Our expertise in JavaScript delivers dynamic, scalable, and high-performing solutions tailored to your business needs."
          image={webdev}
        />
      </div>
