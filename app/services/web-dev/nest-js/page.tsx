...
import webdev from "../../../images/nestjs.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="At LinkShield, we harness the power of NestJS to build scalable and maintainable server-side applications. Our NestJS development services deliver robust, high-performance backend solutions that grow with your business."
          image={webdev}
        />
      </div>
