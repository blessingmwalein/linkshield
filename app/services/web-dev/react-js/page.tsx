...
import webdev from "../../../images/reactjs.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="Empower your web applications with React’s flexibility and performance. At LinkShield, we specialize in crafting scalable, efficient, and interactive React solutions that drive engagement and business growth."
          image={webdev}
        />
      </div>
