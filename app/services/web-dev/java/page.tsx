...
import webdev from "../../../images/java.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="LinkShield offers expert Java development services designed to create secure, scalable, and high-performance applications. From custom enterprise solutions to dynamic web applications, our Java expertise drives your business success."
          image={webdev}
        />
      </div>
