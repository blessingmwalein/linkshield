...
import webdev from "../../../images/nodejs.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="At LinkShield, we leverage NodeJS to build scalable, high-performance server-side applications. Our NodeJS development services deliver robust, efficient, and real-time solutions tailored to your business needs."
          image={webdev}
        />
      </div>
