...
import webdev from "../../../images/python.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="Unlock the full potential of Python with LinkShield's expert development services. From web applications to data-driven solutions, we build scalable, secure, and high-performance Python applications tailored to your needs."
          image={webdev}
        />
      </div>
