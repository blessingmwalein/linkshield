...
import webdev from "../../../images/net.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="Leverage LinkShield's .NET development services to create high-performance, scalable, and secure applications. From custom enterprise solutions to dynamic web apps, our .NET expertise delivers innovation and reliability."
          image={webdev}
        />
      </div>
