...
import webdev from "../../../images/php.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="At LinkShield, we specialize in crafting robust and scalable PHP applications. Our expert PHP development services deliver dynamic, secure, and high-performing web solutions tailored to your business needs."
          image={webdev}
        />
      </div>
