...
import heroimage from "../../images/backend1.png";
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-6">
              <span className="font-bold text-4xl text-black">
                Strong, Resilient Backends
              </span>
              <span className="font-normal text-lg text-black">
                Our team uses the very best technologies in the industry and our
                engineers are masters. Rest assured, we have the right tools to
                solve your problem.
              </span>
            </div>
          </div>
