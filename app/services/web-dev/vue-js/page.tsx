...
import webdev from "../../../images/vuejs.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="Leverage the power of Vue.js to build dynamic, scalable, and high-performance web applications. At LinkShield, our expertise in Vue.js ensures elegant, interactive, and responsive digital experiences tailored to your business needs."
          image={webdev}
        />
      </div>
