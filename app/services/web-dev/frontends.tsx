...
import heroimage from "../../images/fronthero.png";
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-6">
              ...
              Gorgeous, High Converting Frontends
              </span>
              <span className="font-normal text-lg text-black">
              We use the very best technologies to ensure your website remains competitive and benefits from cutting edge advancements. 
              </span>
            </div>
          </div>
