...
import webdev from "../../../images/backend.png"; // Corrected path for default image
    ...
    <>
      <div className="pb-6">
        <PageHeader
          ...
          description="Unlock the full potential of your web applications with LinkShield’s expert Angular development services. Our team delivers scalable, secure, and highly interactive solutions tailored to meet your business needs."
          image={webdev}
        />
      </div>
