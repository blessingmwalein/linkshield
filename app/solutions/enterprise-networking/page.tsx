...
import enterpricehero from "../../images/enterpricehero.png"; // Corrected path for default image
...
import SecurityMonitoringSection from "./monitoring";
...
const Page: React.FC = () => {
  const faqs = [
    {
      question:
        "What strategies does LinkShield use to ensure scalable network architectures?",
      answer:
        "LinkShield uses modular design principles and scalable technologies like SD-WAN to build network infrastructures. These strategies allow for easy expansion and integration of new devices and locations without disrupting existing network performance.",
    },
    {
      question:
        "How does LinkShield handle network security in multi-cloud environments?",
      answer:
        "We implement comprehensive security measures such as encrypted communication, identity and access management (IAM), and continuous monitoring. Our approach ensures that data remains secure across multiple cloud platforms and hybrid environments.",
    },
    {
      question:
        "What are the key benefits of implementing SD-WAN with LinkShield?",
      answer:
        "SD-WAN provides optimized traffic flow, improved application performance, and cost-effective connectivity. LinkShield’s SD-WAN solutions offer secure, flexible, and reliable networking, which enhances the overall efficiency of your network.",
    },
    {
      question:
        "How does LinkShield approach the integration of legacy systems with modern networking solutions?",
      answer:
        "LinkShield conducts thorough assessments of existing systems to understand compatibility and integration challenges. We then design custom solutions that bridge the gap between legacy systems and new technologies, ensuring seamless operation and minimal disruption.",
    },
    {
      question:
        "What proactive measures does LinkShield take to prevent network downtime?",
      answer:
        "LinkShield employs real-time monitoring, automated alerts, and redundancy measures to prevent network downtime. Our proactive approach includes regular maintenance, performance tuning, and the use of failover systems to ensure continuous network availability.",
    },
  ];
    ...
    <>
      ...
      <div className="bg-[#EFEFEF] h-auto pt-10 px-4 sm:px-8 md:px-16 lg:px-28 xl:px-[140px] ">
        ...
        <div className="mt-10 flex flex-col justify-center items-center">
          <span className="font-bold text-2xl w-3/4 justify-center items-center text-center text-black">
            Partner with LinkShield for Networking Excellence
          </span>
          ...
          <div className="mt-10 pb-10">
            <div className="flex flex-col items-center gap-8 p-4">
              <div className="flex gap-1">
                {/* Replace these SVGs with your actual SVG paths */}
                <svg
                ...
                >
                  <path
                    d="M9.07088 0.61625C9.41462 -0.200209 10.5854 -0.200208 10.9291 0.616252L12.9579 5.43514C13.1029 5.77934 13.4306 6.01452 13.8067 6.04431L19.0727 6.46138C19.9649 6.53205 20.3267 7.63204 19.6469 8.20731L15.6348 11.6026C15.3482 11.8451 15.223 12.2257 15.3106 12.5882L16.5363 17.6649C16.744 18.525 15.7969 19.2049 15.033 18.744L10.5245 16.0235C10.2025 15.8291 9.7975 15.8291 9.47548 16.0235L4.96699 18.744C4.20311 19.2049 3.25596 18.525 3.46363 17.6649L4.68942 12.5882C4.77698 12.2257 4.65182 11.8451 4.36526 11.6026L0.353062 8.20731C-0.326718 7.63204 0.0350679 6.53205 0.927291 6.46138L6.19336 6.04431C6.5695 6.01452 6.89716 5.77934 7.04207 5.43514L9.07088 0.61625Z"
                    fill="black"
                  />
                </svg>
                <svg
              ...
              <span className="font-bold text-xl text-center text-black w-1/2">
